...
- Name: 01-auth.spec.ts >> 01 - Autenticación >> login con credenciales inválidas muestra mensaje de error
- Location: e2e\01-auth.spec.ts:16:7
...
- main:
  ...
  - text: Contraseña
  - textbox "Contraseña"
  - button "Contraseña appended action": 󰈈
  - alert
  - button "Login"
```
