...
- Name: 04-invoices.spec.ts >> 04 - Facturas >> abrir el formulario de nueva factura (si la caja está abierta)
- Location: e2e\04-invoices.spec.ts:72:7
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e12]:
      - generic [ref=e13]:
        - generic [ref=e15]:
          - generic [ref=e17]: 󰇮
          - textbox "Email" [ref=e19]: admin@test.com
          - generic:
            - generic:
              - generic: Email
        - alert [ref=e20]
      - generic [ref=e22]:
        - generic [ref=e24]:
          - generic [ref=e26]: 󰌾
          - textbox "Contraseña" [ref=e28]: password
          - button "Contraseña appended action" [ref=e30] [cursor=pointer]: 󰈈
          - generic:
            - generic:
              - generic: Contraseña
        - alert [ref=e31]
      ...
      - alert [ref=e35]:
        - generic [ref=e37]: 󰅙
        - generic [ref=e38]: timeout of 30000ms exceeded
```
